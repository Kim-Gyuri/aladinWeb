...
public class QOrderItem extends EntityPathBase<OrderItem> {
    ...
    private static final long serialVersionUID = 1633275890L;
    ...
    public final EnumPath<webservice.aladin.domain.enums.OrderStatus> orderStatus = createEnum("orderStatus", webservice.aladin.domain.enums.OrderStatus.class);
